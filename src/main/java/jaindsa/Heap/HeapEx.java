...
public class HeapEx {
	...
	public static void demo(String[] args) {
		...
		System.out.println("Printing Priority jaindsa.collectionsandlang.Queue Heap : " + pq);
	
		System.out.print("Dequeue elements of Priority jaindsa.collectionsandlang.Queue ::");
